          ...
          <form onSubmit={handleSearch} className="mb-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-white border border-gray-200 rounded-2xl text-lg focus:outline-none focus:border-gray-400 focus:ring-2 focus:ring-gray-100"
